...
namespace SU_COIN_BACK_END.Constants.MessageConstants
{
    public static class MessageConstants
    {
        ...
        public const string UPLOAD_FILE_TOO_LARGE = "Maximum file size is exceeded.";
        ...
        public const string REGISTER_SUCCESSFUL_EMAIL = "A verification email has been sent to your email address. Please verify your email to complete the registration.";
