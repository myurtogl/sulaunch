...
namespace SU_COIN_BACK_END.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<ServiceResponse<string>> DeleteUserAsAdmin(int userID){
            ...
            try{
                ...
                else if (user.Role == UserRoleConstants.ADMIN){
                    response.Message = $"You cannot delete an {user.Role}.";
                    return response;
                }
        ...
        public async Task<ServiceResponse<UserDTO>> UpdateUser(UserDTO user)
        {
            ...
            try
            {
                if (user == null || user.Name == null || user.Surname == null || user.MailAddress == null || user.Username == null)
                {
        ...
        public async Task<ServiceResponse<Int32>> LearnUserCount()
        {
            ServiceResponse<Int32> response = new ServiceResponse<Int32>();
            try
            {
                Int32 userCount = await _context.Users.CountAsync();
